...
import {
  showError,
  showSuccess,
} from "../../../../components/UserComponent/CommonComponent/Message/Message";
...
const Login = () => {
  ...
  const handleGetDetailUser = async (token) => {
    ...
    const { name, email, phone, isAdmin, _id } = res.data;
    dispatch(updateUser({ name, email, phone, isAdmin, _id }));
  };
