...
const FooterPickleCourt = () => {
  return (
    <div style={{ backgroundColor: 'rgb(53, 58, 64)' }}>
        <div style={{maxWidth: '1200px', margin: '0 auto', padding: "8px", backgroundColor: 'rgb(53, 58, 64)', color: "white"}}>
...
export default FooterPickleCourt